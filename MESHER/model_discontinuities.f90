...
case('prem')
  ...
  call prem_discont
case('prem_ani')
  write(6,*)'Reading PREM_ANI discontinuities...';call flush(6)  
...
case('prem_onecrust_ani')
  write(6,*)'Reading PREM_ONECRUST_ANI discontinuities...';call flush(6)  
  call prem_onecrust_ani_discont
case('prem_light')
  write(6,*)'Reading PREM_LIGHT discontinuities...';call flush(6)  
  call prem_light_discont   
case('prem_light_ani')
  write(6,*)'Reading PREM_LIGHT_ANI discontinuities...';call flush(6)  
