...
!
  ...
  public :: comp_partial_deriv_subpar
  private
!
  contains
!
!
!dk mapping_subpar-------------------------------------------------------
  double precision function mapping_subpar(xi,eta,nodes_crd,iaxis)
!
...
!
  ...
  eta = p(2)
!
  quadfunc_map_subpar = (s-mapping_subpar(xi,eta,nodes_crd,1))**2 &
                      + (z-mapping_subpar(xi,eta,nodes_crd,2))**2
...
!
  ...
  grd(1) = -((s-mapping_subpar(xi,eta,nodes_crd,1))*a&
            +(z-mapping_subpar(xi,eta,nodes_crd,2))*c)  
  grd(2) = -((s-mapping_subpar(xi,eta,nodes_crd,1))*b&
            +(z-mapping_subpar(xi,eta,nodes_crd,2))*d)

  end subroutine grad_quadfunc_map_subpar
!--------------------------------------------------------------
!
!dk comp_partial_deriv_subpar----------------------------------
  subroutine comp_partial_deriv_subpar(dsdxi,dzdxi,dsdeta,dzdeta,xi,eta,nodes_crd)

  double precision, intent(out) :: dsdxi,dzdxi,dsdeta,dzdeta
  double precision, intent(in) :: xi,eta,nodes_crd(8,2)
  integer :: inode
...
! functions
  ...
  end subroutine comp_partial_deriv_subpar
!----------------------------------------------------------------------
!
!dk s_over_oneplusxi_axis_subpar--------------------------------------------
  double precision function s_over_oneplusxi_axis_subpar(xi,eta,nodes_crd)
! 
...
!
!dk jacobian_subpar---------------------------------------------------
  double precision function jacobian_subpar(xi,eta,nodes_crd)
!
!
...
!dk jacobian_srf_subpar-----------------------------------------------
  double precision function jacobian_srf_subpar(xi,crdedge)
!
...
!
  dsdxi = s1*(xi-half) + s2*(-two*xi) + s3*(xi+half)
  dzdxi = z1*(xi-half) + z2*(-two*xi) + z3*(xi+half)
!
...
!
!dk alphak_subpar------------------------------------------------------
  double precision function alphak_subpar(xi,eta,nodes_crd)
!
...
!
!dk betak_subpar------------------------------------------------------
  double precision function  betak_subpar(xi,eta,nodes_crd)
!
! This routines returns the value of
!
...
!
!dk gammak_subpar-----------------------------------------------------
  double precision function  gammak_subpar(xi,eta,nodes_crd)
!
! This routines returns the value of
!
...
!
!dk deltak_subpar-----------------------------------------------------
  double precision function deltak_subpar(xi,eta,nodes_crd)
!
! This routines returns the value of
!
...
!
!dk epsilonk_subpar-----------------------------------------------------
  double precision function epsilonk_subpar(xi,eta,nodes_crd)
!
! This routines returns the value of
!
...
!
!dk zetak_subpar-----------------------------------------------------
  double precision function zetak_subpar(xi,eta,nodes_crd)
!
! This routines returns the value of
!
...
!
!dk alpha_subpar------------------------------------------------------
  double precision function alpha_subpar(xi,eta,nodes_crd)
!
! This routines returns the value of 
!
...
!
  ...
  inv_jacob  = one/(a*d - b*c)
!
  alpha_subpar  = -mapping_subpar(xi,eta,nodes_crd,1)*inv_jacob*a*b
!
  end function alpha_subpar 
!---------------------------------------------------------------------------
!
!dk beta_subpar------------------------------------------------------
  double precision function  beta_subpar(xi,eta,nodes_crd)
!
! This routines returns the value of
!
...
!
  ...
  inv_jacob  = one/(a*d - b*c)
!
  beta_subpar   = mapping_subpar(xi,eta,nodes_crd,1)*inv_jacob*(a**2)
!
  end function beta_subpar 
!---------------------------------------------------------------------------
!
!dk gamma_subpar-----------------------------------------------------
  double precision function  gamma_subpar(xi,eta,nodes_crd)
!
! This routines returns the value of
!
...
!
  ...
  inv_jacob  = one/(a*d - b*c)
!
  gamma_subpar   = mapping_subpar(xi,eta,nodes_crd,1)*inv_jacob*(b**2)
!
  end function gamma_subpar
!---------------------------------------------------------------------------
!
!dk delta_subpar-----------------------------------------------------
  double precision function delta_subpar(xi,eta,nodes_crd)
!
! This routines returns the value of
!
...
!
  ...
  inv_jacob  = one/(a*d - b*c)
!
  delta_subpar   = -mapping_subpar(xi,eta,nodes_crd,1)*inv_jacob*c*d
!
  end function delta_subpar
!---------------------------------------------------------------------------
!
!dk epsilon_subpar-----------------------------------------------------
  double precision function epsilon_subpar(xi,eta,nodes_crd)
!
! This routines returns the value of
!
...
!
  ...
  inv_jacob  = one/(a*d - b*c)
!
  epsilon_subpar   =  mapping_subpar(xi,eta,nodes_crd,1)*inv_jacob*(c**2)
!
...
!
!dk zeta_subpar-----------------------------------------------------
  double precision function zeta_subpar(xi,eta,nodes_crd)
!
! This routines returns the value of
!
...
!
  ...
  inv_jacob  = one/(a*d - b*c)
!
  zeta_subpar   =  mapping_subpar(xi,eta,nodes_crd,1)*inv_jacob*(d**2)
!
  end function zeta_subpar
!---------------------------------------------------------------------------
!
!dk mgrad_pointwise_subpar------------------------------------------------------
  subroutine mgrad_pointwise_subpar(mg,xi,eta,nodes_crd)
!
...
!
  mg(1,1)  = mapping_subpar(xi,eta,nodes_crd,1)*a
  mg(1,2)  = mapping_subpar(xi,eta,nodes_crd,1)*b 
  mg(2,1)  = mapping_subpar(xi,eta,nodes_crd,1)*c
  mg(2,2)  = mapping_subpar(xi,eta,nodes_crd,1)*d
!
  end subroutine mgrad_pointwise_subpar
!---------------------------------------------------------------------------
!
!dk mgrad_pointwisek_subpar------------------------------------------------------
  subroutine mgrad_pointwisek_subpar(mg,xi,eta,nodes_crd)
!
! This routines returns the following matrix:
!            +                     +
!            |(ds/dxi)  | (ds/deta)|
...
!
!dk shp8der------------------------
  subroutine shp8der(xi,eta,shpder)
!
