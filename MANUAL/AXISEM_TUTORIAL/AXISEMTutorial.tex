...
\begin{enumerate}
    \item Open a terminal, go to the \ttilde\verb|/Desktop/axisem/MESHER| folder and open the
...
\begin{enumerate}
    ...
    colorscale (e.g.\ 'black body radiation' looks nice).
...
Postprocessing is a key feature of AxiSEM: the source mechanism can be modified
without redoing the expensive simulation.
