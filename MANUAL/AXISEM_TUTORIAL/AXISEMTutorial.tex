...
\begin{enumerate}
    ...
    * For more information on the folder structure of your Virtual-box, refer to
    ...
    \item Compare the seismograms calculated for two different source mechanism
    ...
    \item Change the filter, as explained in step 4, and repeat step 7. Try different filter setting and compare the results.
...
\begin{enumerate}
    ...
    the required PyAxi input files to re-produce them.
