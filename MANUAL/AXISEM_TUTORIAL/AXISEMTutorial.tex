...
%%\caption{This should be the caption for \texttt{AXISEMTutorial-fig005.jpg}.}
%%\end{figure}

{\small{}Figure A2: Folder structure}
\end{center}
...
%%\caption{This should be the caption for \texttt{AXISEMTutorial-fig008.pict}.}
%%\end{figure}

%%\begin{figure}[htbp]
\includegraphics[width=235pt, height=309pt, keepaspectratio=true]{AXISEMTutorial-fig009.pdf}
%%\caption{This should be the caption for \texttt{AXISEMTutorial-fig009.pict}.}
%%\end{figure}
...
%%\caption{This should be the caption for \texttt{AXISEMTutorial-fig010.pict}.}
%%\end{figure}

%%\begin{figure}[htbp]
\includegraphics[width=233pt, height=311pt, keepaspectratio=true]{AXISEMTutorial-fig011.pdf}
%%\caption{This should be the caption for \texttt{AXISEMTutorial-fig011.pict}.}
%%\end{figure}
...
%%\caption{This should be the caption for \texttt{AXISEMTutorial-fig012.png}.}
%%\end{figure}
...
%%\caption{This should be the caption for \texttt{AXISEMTutorial-fig013.png}.}
%%\end{figure}
...
%%\caption{This should be the caption for \texttt{AXISEMTutorial-fig014.png}.}
%%\end{figure}
