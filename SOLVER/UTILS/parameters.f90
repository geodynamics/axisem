...
! requires the fluid displacement/velocities
  ...
  if (add_hetero) then
    ...
    if (file_exists) then 
       ...
       read(91,*)r_het1,r_het2
       read(91,*)th_het1,th_het2
       read(91,*)delta_rho
       read(91,*)delta_vp
       read(91,*)delta_vs
       close(91)
       ...
       if (lpr) then 
          write(6,*)'Specification of heterogeneous region:'
          write(6,*)'Radius (lower/upper bound) [km]:',r_het1/1000.,r_het2/1000.
          write(6,*)'Colatitude (lower/upper bound) [deg]:',th_het1*180./pi,th_het2*180./pi
          write(6,*)'delta rho [%]:',delta_rho
          write(6,*)'delta vp  [%]:',delta_vp
          write(6,*)'delta vs  [%]:',delta_vs
       endif
    else 
       if (lpr) then 
          write(6,*)'WARNING!!!!!!!!!!!!!!!!!!!!!!!!!!!!'
