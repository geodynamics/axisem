            ...
            do ipol=ibeg,iend
                do jpol=ibeg,iend
                    ...
                    write(60000+mynum,14) r, theta, rho(ipol,jpol,iel), &
                                          sqrt( (lambda(ipol,jpol,iel) &
                                                + 2.*mu(ipol,jpol,iel)) &
                                                / rho(ipol,jpol,iel) ), &
                                          sqrt( mu(ipol,jpol,iel) &
                                                / rho(ipol,jpol,iel))
                enddo
            enddo
        endif
...
!=============================================================================
!> Plot the background model into vtk files. No idea why this is done here,
!! since it is already done in the MESHER.
