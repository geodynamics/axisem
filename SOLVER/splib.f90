...
subroutine lag_interp_deriv_wgl(dl,xi,i,N)
  ...
  real(dp)              :: mn_xi_i, mnprime_xi_i
  real(dp)              :: mnprimeprime_xi_i
  real(dp)              :: mn_xi_j, mnprime_xi_j 
  real(dp)              :: mnprimeprime_xi_j
  real(dp)              :: DN
  integer                       :: j
