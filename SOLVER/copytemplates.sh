...
cp SOLVER/sourceparams.dat.TEMPLATE SOLVER/CMTSOLUTION
cp SOLVER/CMTSOLUTION.dat.TEMPLATE SOLVER/sourceparams.dat
cp SOLVER/inparam_xdmf.TEMPLATE SOLVER/inparam_xdmf
